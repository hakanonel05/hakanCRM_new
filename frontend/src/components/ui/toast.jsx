...
const ToastClose = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-1 top-1 rounded-md p-1 text-foreground opacity-0 transition-opacity hover:text-foreground focus:opacity-100 focus:outline-none focus:ring-1 group-hover:opacity-100 group-[.destructive]:text-primary-foreground group-[.destructive]:hover:text-primary-foreground group-[.destructive]:focus:ring-status-danger-line group-[.destructive]:focus:ring-offset-destructive",
      className
    )}
    toast-close=""
    {...props}>
