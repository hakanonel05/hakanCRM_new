  ...
  if (error) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-muted/30">
        <div className="text-center p-8 bg-card rounded-xl shadow-none max-w-md">
          <div className="w-12 h-12 bg-status-danger-bg rounded-full flex items-center justify-center mx-auto mb-4">
            <svg className="w-6 h-6 text-status-danger-fg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-muted/30">
      <div className="text-center">
        <div className="w-12 h-12 border-4 border-status-success-line border-t-status-success-fg rounded-full animate-spin mx-auto mb-4"></div>
